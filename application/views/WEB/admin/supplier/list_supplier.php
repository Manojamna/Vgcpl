            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-red bold uppercase">Supplier Listing</span>
                        </div>
                        <a href="<?=WEB_URL.'addsupplier'?>" class="btn btn blue pull-right">Add Supplier</a>
                    </div>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td>Baladia</td>
                                        <td>56842</td>
                                        <td><a href="tel:9956843520">9956843520</a> </td>
                                        <td><a href="mailto:vconcrete@gmail.com">vconcrete@gmail.com</a> </td>
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td>Bhuj</td>
                                        <td>26435</td>
                                        <td><a href="tel:9956843520">9946857315</a> </td>
                                        <td><a href="mailto:Hirani@gmail.com">Hirani@gmail.com</a> </td>
                                        <td><a href="#" class="btn btn blue"><i class="fa fa-pencil-square-o"></i></a>
                                            <a href="#" class="btn btn red"><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
                                    </tbody>
