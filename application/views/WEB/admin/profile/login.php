    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?=base_url().'index.php/web'?>">
                <img src="<?=base_url()?>assets/pages/img/logo-big.png" alt="" width="200" height="50"/> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="email" placeholder="Email" name="email" value="<?= isset($_COOKIE['email']) && !empty($_COOKIE['email']) ? $_COOKIE['email'] : ''?>"/> </div>
                </div>
                <div class="form-group">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> <?=date('Y')?> &copy; Toughglass All rights received. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
