    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><span>Manager Listing</span></li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption"><span class="caption-subject font-red bold uppercase">Manager Listing</span></div>
                        <a href="" class="btn btn blue pull-right">Add Manager</a>
                    </div>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td><a href="mailto:BharatVaghela@gmail.com">BharatVaghela@gmail.com </a></td>
                                        <td>from Bhuj</td>
                                        <td>Photo</td>
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td><a href="mailto:MohanSharma@gmail.com">MohanSharma@gmail.com </a></td>
                                        <td>from Mandvi</td>
                                        <td>Photo</td>
                                        <td><a href="#" class="btn btn blue"><i class="fa fa-pencil-square-o"></i></a>
                                            <a href="#" class="btn btn red"><i class="fa fa-trash-o"></i></a></td>
