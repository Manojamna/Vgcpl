            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-red bold uppercase">Fleet Listing</span>
                        </div>
                        <a href="<?=WEB_URL.'addfleet'?>" class="btn btn blue pull-right">Add Fleet</a>
                    </div>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        <td> 2 </td>
                                        <td>Ankit Mor</td>
                                        <td><a href="tel:965986512437">9659865124</a> </td>
                                        <td>Type 2 </a></td>
                                        <td>165 </a></td>
                                        <td>7000 </a></td>
                                        <td>Yes </a></td>
