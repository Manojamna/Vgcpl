    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?= WEB_URL . 'role' ?>">Role list</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span>Edit Role</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-md-5 control-label">Index</label>
                                            <div class="col-md-6">
                                                <input type="text" name="order_index" value="<?=isset($data['order_index']) && !empty($data['order_index']) ? $data['order_index'] : ''?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
