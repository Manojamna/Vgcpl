    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li><span>Customer Listing</span></li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption"><span class="caption-subject font-red bold uppercase">Customer Listing</span></div>
                        <a href="<?=WEB_URL.'addcustomer'?>" class="btn btn blue pull-right">Add Customer</a>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                    ...
                                    <tbody>
                                        <tr class="gradeX odd" role="row">
                                            ...
                                            <td>Bhuj</td>
                                            <td><a href="tel:9985763251">9985763251</a> </td>
                                            <td><a href="tel:02832172839">02832172839</a> </td>
                                            <td><a href="<?=WEB_URL.'customersite'?>">3 </a></td>
                                            <td><a href="<?=WEB_URL.'customersite'?>">2 </a></td>
                                        ...
                                        <tr class="gradeX odd" role="row">
                                            ...
                                            <td>Mohan Sharma</td>
                                            <td>Mandvi</td>
                                            <td><a href="tel:9985763251">9946857260</a> </td>
                                            <td><a href="tel:02832172839">02832658419</a> </td>
                                            <td><a href="<?=WEB_URL.'customersite'?>">1 </a></td>
                                            <td><a href="">3 </a></td>
                                            <td><a href="#" class="btn btn blue"><i class="fa fa-pencil-square-o"></i></a>
                                                <a href="#" class="btn btn red"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>
