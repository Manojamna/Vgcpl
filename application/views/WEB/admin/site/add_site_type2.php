                                ...
                                <div class="form-body">
                                    <ul class="nav nav-pills nav-justified steps">
                                        ...
                                        <li>
                                            <a href="#tab3" data-toggle="tab" class="step active">
                                                ...
                                                <span class="desc"><i class="fa fa-check"></i> Construction Site </span>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <div class="portlet light bordered">
                                                        <div class="portlet-title">
                                                            <div class="caption font-dark">
                                                                <span class="caption-subject bold uppercase">Import Tande Data Excel Sheet</span>
                                                            </div>
                                                            <div class="actions">
                                                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                                                    <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active">
                                                                        <input type="radio" name="options" class="toggle" id="option1">Import</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="portlet-body">
                                                            <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6">
                                                                        <div id="sample_1_filter" class="dataTables_filter">
                                                                            <label>Search:
                                                                                <input type="search" class="form-control input-sm input-small input-inline" aria-controls="sample_1">
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="table-scrollable">
                                                                    <table class="table table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                                                        <thead>
                                                                            <tr class="" role="row">
                                                                                <th tabindex="0" aria-controls="sample_1"> ID </th>
                                                                                <th tabindex="0" aria-controls="sample_1"> Parameter </th>
                                                                                <th tabindex="0" aria-controls="sample_1"> Quantity </th>
                                                                                <th tabindex="0" aria-controls="sample_1"> Rate </th>
                                                                                <th tabindex="0" aria-controls="sample_1"> Unit </th>
                                                                                <th tabindex="0" aria-controls="sample_1"> Block </th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-5 col-sm-5">
                                                                        <div class="dataTables_info" id="sample_1_info" role="status" aria-live="polite">Showing 1 to 1 of 1 entries</div>
                                                                    </div>
                                                                    <div class="col-md-7 col-sm-7">
                                                                ...
                                                                <div class="form-actions" align="right">
                                                                    <div class="row">
                                                                        <div class="col-md-offset-3 col-md-9">
                                                                            <a href="javascript:;" class="btn green button-submit"> Review
                                        ...
                                        <div class="tab-pane" id="tab4">
                                            ...
                                            <h4 class="form-section">Construction Site</h4>
                                            <div>
                                                <div class="table-scrollable">
                                                    <table class="table table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                                                        <thead>
