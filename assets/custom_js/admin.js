jQuery(document).ready(function () {
    ...
    $('#cancel_image').on('click', function () {
        ...
        $(".img-preview > img").css('height', '200px');
        $(".img-preview > img").css('width', '200px');
        $(".img-preview > img").css('margin', '0px');
        $(".img-preview > img").css('background-color', 'white');
        $('#edit_thumb').css('display', 'none');
        $('#myModal').modal('hide');
    });
    // End image crope code
    ...
    edit_admin.validate({
        ...
        submitHandler: function (edit_admin) {
            ...
            $.ajax({
                url: BASEURL + 'adminlogin/update_profile',
                type: 'POST',
                data: formData,
                async: true,
    ...
    change_pass.validate({
        ...
        messages: {
            current_password: {
                ...
                minlength: "Minimum five character required"
            },
            new_password: {
